...
export default function Spaces() {
    const [slides] = useState([
        ...
        { image: 'images/space2.jpg', heading: 'THE BELLECOUR ROOM', description: 'Up tp 90 guests can be seated in our private dining space for customized dinners, lunches, ceremonies and celebrations.' },
        ...
        <>
            <div className='bg-white' id="spaces">
                <Container fluid className=''>
                    <Row className=''>
                        <Col md={4} className='position-relative p-0 d-flex justify-content-center align-items-left flex-column'>
                                        ...
                                        <>
                                            <div
                                                ...
                                                {(index == Ind) && < div hidden={hover} className={`text-white ${style.hovertext}` }>
                                                    <p className=' fs-1 fw-bold'>{slide.heading}</p>
